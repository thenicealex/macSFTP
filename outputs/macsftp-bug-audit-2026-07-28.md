...
1. ~~**P0：APP-EDIT-001**~~ ✅ 已修（2026-07-29，PR 3，`048a746..c4a455f`）
2. ~~**P0：SFTP-TRANSFER-001**~~ ✅ 已修（2026-07-29，PR 1，`6914960`）
3. ~~**P1：CORE-SFTP-001**~~ ✅ 已修（2026-07-29，PR 2，`c242c93..c6680f9`）
4. ~~**P2：TEST-001**~~ ✅ 已修（2026-08-01，`1e3f4df`）
5. ~~**P3：APP-EDIT-002、APP-EDIT-003、SFTP-MOCK-001**~~ ✅ 已修（2026-08-01，`bb6c452`、`03c62a4`）

> 2026-08-01 补充：全部 7 项缺陷均已修复并带回归测试。本报告其余内容保留为历史证据；
> 交互式 GUI 手测已于 2026-08-01 由用户签字（见 `docs/release-evidence/v0.1.0.md`），
> 本机 Metal 编译器现已可用，完整 `scripts/check.sh` 全绿。
